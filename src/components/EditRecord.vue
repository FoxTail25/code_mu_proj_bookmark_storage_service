...
export default {
  ...
  methods: {
    ...
    restoreLink(linkId) {
      let groupId = this.selectedToEdit;
      store.restoreDeletedLinkInSelectedGroup(groupId, linkId);
    },
    ...
    <div class="mt-2">
      <div class="row justify-content-center">
        <div class="col-10 mb-2">
          <select class="form-select" aria-label="Default select example" v-model="selectedToEdit" ref="groupSelect">
    ...
    <div v-if="group_selected" class="mt-2">
      <div class="row justify-content-center">
        ...
        <TransitionGroup name="list" tag="ol"
          ...
          <li v-for="(elem) in getSelectedGroupRecord" :key="elem.id" class="list-group-item d-flex px-1 px-sm-2">
            ...
            <div class="row w-100">
              <div class="col-12 d-flex align-items-center justify-content-between pe-0 ps-sm-3">
                ...
                <button v-else class="btn btn-primary p-1 mx-0 lh-1" @click="saveLinkRecordFromGroup(elem.id)"
                  ...
                  <div class="col-12 mb-2">
                    <label for="inputLink" class="row g-1">
                      ...
                      <div class="col-9 col-sm-10 col-md-10">
                        <input type="text" class="form-control" placeholder="Адрес ссылки" aria-label="Username"
                          aria-describedby="basic-addon1" id="inputLink" v-model="editOldLinkRecord.link">
                      </div>
                    </label>
                  </div>
                  <div class="col-12  mb-2">
                    ...
                    <label class="row g-1" for="inputDescription">
                      ...
                      <div class="col-9 col-sm-10 col-md-10">
                        <input type="text" class="form-control" placeholder="Описание" aria-label="Username"
                          aria-describedby="basic-addon3" id="inputDescription" v-model="editOldLinkRecord.description">
                      </div>
                    </label>
                  </div>
        ...
        <div v-if="isDeleted" class="row justify-content-center mt-4">
          ...
          <p class="text-center mb-0">(записи будут автоматически удалены после обновления страницы)</p>
          <p class="text-center">(Можно удалить записи из группы, затем изменить группу и восстановить записи. Таким образом можно переносить записи из одной группы в другую группу)</p>
        ...
        <PageHeader :msg="'(Заполните обязательные поля и нажмите &laquo;Добавить запись в группу&raquo;)'" :num="6"
          :tagName="'P'" />
            ...
            <div class="col-11 col-sm-10 mb-2">
              <label for="inputLink" class="row g-1">
                ...
                <div class="col-9 col-sm-10 col-md-11">
                  <input type="text" class="form-control" placeholder="Адрес ссылки" aria-label="Username"
                    aria-describedby="basic-addon1" id="inputLink" v-model="editNewLinkRecord.link" ref="link">
                </div>
              </label>
            </div>
            <div class="col-11 col-sm-10 mb-2">
              <label class="row g-1" for="inputName">
                ...
                <div class="col-9 col-sm-10 col-md-11">
                  <input type="text" class="form-control" placeholder="Отображаемое название" aria-label="Username"
                    aria-describedby="basic-addon2" id="inputName" v-model="editNewLinkRecord.name" ref="name">
                </div>
              </label>
            </div>
            <div class="col-11 col-sm-10 mb-2">
              <label class="row g-1" for="inputDescription">
                ...
                <div class="col-9 col-sm-10 col-md-11">
                  <input type="text" class="form-control" placeholder="Описание" aria-label="Username"
                    aria-describedby="basic-addon3" id="inputDescription" v-model="editNewLinkRecord.description"
                    ref="description">
                </div>
              </label>
            </div>
